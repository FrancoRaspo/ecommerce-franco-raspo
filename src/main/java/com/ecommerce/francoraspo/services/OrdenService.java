...
public interface OrdenService {
        ...
        Optional<Orden> nuevaOrden(final OrdenRequest ordenRequest) throws Exception;

        Optional<Orden> nuevaOrdenByCarritoId(final String carritoId, final OrdenRequest ordenRequest) throws Exception;
